...
class DataObj:
    def __init__(self, textlabels, axislabels, dataarray):
        self.textlabels = textlabels
        self.axislabels = axislabels
        self.dataArray = dataarray

def visData(popfile='populate.model', frac=None):
    """
    ...
    return DataObj(textlabels, axislabels, dataArray)
...
class VisualizeFrame(wx.Frame):
    ...
    def create_main_panel(self):
        ...
        # next to the canvas
        self.radioBoxX = wx.RadioBox(self.panel, 1, 'X Axis',
                                    choices = self.dataObj.textlabels,
                                    majorDimension=1,
                                    style = wx.RA_SPECIFY_COLS)

        self.radioBoxY = wx.RadioBox(self.panel, 2, 'Y Axis',
                                    choices = self.dataObj.textlabels,
                                    majorDimension=1,
                                    style = wx.RA_SPECIFY_COLS)
    ...
    def draw_figure(self):
        self.axes.clear()
        self.axes.plot(self.dataObj.dataArray[self.xIndex],
                             self.dataObj.dataArray[self.yIndex],
                             'r.')

        self.axes.set_xlabel(self.dataObj.axislabels[self.xIndex])
        self.axes.set_ylabel(self.dataObj.axislabels[self.yIndex])
...
if __name__ == '__main__':
    ...
    dataObj = visData(popfile = args.f, frac=args.frac)
